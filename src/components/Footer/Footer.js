  ...
  return (
    <div className={isDarkMode? "footer-dark footer":"footer"}>
          ...
          <div className="row text-center text-md-start p-md-4 mt-md-5">
            ...
            <div className="col-12 mx-auto col-md-4">
              ...
              <ul>
                <li>
                  <a className="link"
                    href="https://www.linkedin.com/in/abhishekh-ashok-singh-9938b7242/"
                    target="blank"
                  >
                    LinkedIn
                  </a>
                ...
                <li>
                  <a className="link" href="https://github.com/sabhishekh" target="blank">
                    GitHub
                  </a>
                </li>
                <li>
                  <a className="link"
                    href="https://www.instagram.com/I_M_ABHISHEKH_SINGH777/"
                    target="blank"
                  >
                    InstaGram
                  </a>
      ...
      <div className="d-flex  justify-content-between px-md-5 mx-md-5 ">
        <span className="link">&copy; Made By Abhishekh| All Rights Reserved</span>
        <span className="me-2">
          <a className="link"
            href="https://www.linkedin.com/in/abhishekh-ashok-singh-9938b7242/"
            target="blank"
          ...
          <a className="link" href="https://www.github.com/sabhishekh" target="blank">
            <i className="fa-brands fa-square-github p-1 p-md-3 fs fs-md-4"></i>
          </a>
          <a className="link" href="https://www.instagram.com/I_M_ABHISHEKH_SINGH777/" target="blank">
